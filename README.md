...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/nlA18fbyLp)
...
```sh
npx nx serve taskman
```

To create a production bundle:

```sh
npx nx build taskman
```

To see all available targets to run for a project, run:

```sh
npx nx show project taskman
```
